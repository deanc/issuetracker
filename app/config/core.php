 ...
 */
	Configure::write('Security.salt', 'asdfadsfdsfhjklhasdc87897a342139487293847adsfa');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '128312890738901723897129087390789078095444');
